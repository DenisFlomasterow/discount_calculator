...
Приложение позволяет рассчитывать цену товара после одной или нескольких скидок, учитывать налог, сохранять историю
расчётов и экспортировать данные в CSV.
